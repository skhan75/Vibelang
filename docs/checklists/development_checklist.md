...
- [x] Add periodic docs usability review checklist (new user walkthroughs) (tracking: `VG-024`; owner: Docs + DX + CI; evidence: `docs/checklists/docs_walkthrough_checklist.md`)
