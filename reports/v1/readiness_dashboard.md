...
| Compiler self-host readiness | OPEN-P0 | `docs/development_checklist.md` section `7.3.e Compiler Self-Host Readiness (First)` | Compiler/Release | Must pass one RC dry-run gate before language-surface expansion closes |
...
| V1-P0-SELFHOSTREADY | P0 | Compiler/Release | Execute self-host readiness gate (`7.3.e`) with parity evidence and RC dry-run proof in `reports/v1/selfhost_readiness.md` | 2026-03-01 | Open |
